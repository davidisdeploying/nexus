...
# charlie 8->9 / delta 10->9: the photo-archive-backup guard moved with its timer
# when the photo-archive triggers relocated to tensor (2026-08-07).
# Updated 2026-08-07: Loupe and preftool moved to charlie, Prospect to alpha, and
# vault-webdav was retired. Delta is no longer an application host.
_EXPECTED_HOST_COUNTS = {"alpha": 12, "charlie": 12, "delta": 6, "echo": 1}
...
DELTA_ROWS: list[dict] = [
    ...
    {
        "id": "charlie-systemd-loupe", "kind": "guard", "owner": "david", "host": "charlie",
        ...
        "cadence_timeout": "continuous; 3s restart backoff",
        "last_check_evidence": "active since 2026-08-07T12:27:04Z (charlie); listening 0.0.0.0:8000",
        "last_action_evidence": "NRestarts=0",
        "status": "dormant", "status_detail": "Registered and running; guard never yet needed to fire.",
    ...
    {
        "id": "charlie-systemd-preftool", "kind": "guard", "owner": "david", "host": "charlie",
        ...
        "last_check_evidence": "active since 2026-08-07T10:45:32Z (charlie)",
        "last_action_evidence": "NRestarts=0",
        "status": "dormant", "status_detail": "Registered and running; guard never yet needed to fire.",
    ...
    {
        "id": "charlie-systemd-photo-archive-backup", "kind": "guard", "owner": "david", "host": "charlie",
        "label": "photo-archive-backup.service supervision",
        "source": "~/.config/systemd/user/photo-archive-backup.service (Restart=on-failure/30s)",
        "protected_target": "photo-archive-backup.service",
        "cadence_timeout": "timer-fired; 30s restart backoff",
        "last_check_evidence": "idle between timer fires (expected)",
        "last_action_evidence": "NRestarts=0",
