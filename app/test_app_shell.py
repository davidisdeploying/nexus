...
class AppShellTests(unittest.TestCase):
    ...
    def test_manifest_and_service_worker_own_the_new_icon_generation(self) -> None:
        ...
        self.assertIn("const CACHE_GENERATION = 'v20'", service_worker)

        eye_source = (repo_root / "static" / "icons" / "nexus-eye.svg").read_text()
        transform = re.search(
        ...
        self.assertAlmostEqual(scale * (499.593 - 19.5), 512 * 0.76, places=3)
        self.assertAlmostEqual(tx + scale * ((19.5 + 499.593) / 2), 256, places=3)
        self.assertAlmostEqual(ty + scale * ((99.72 + 471.875) / 2), 256, places=3)
    ...
    def test_legacy_page_headers_use_the_shared_supplied_eye(self) -> None:
        ...
        self.assertEqual(eye_html.count('class="nexus-eye-mark"'), 1)
        self.assertIn('viewBox="0 0 512 512"', eye_html)
    ...
    def test_header_groups_brand_and_orders_desktop_actions(self) -> None:
        ...
        self.assertIn("<h1>Nexus</h1>", html[brand_start:brand_end])
    ...
    def test_dashboard_chrome_has_one_product_h1_and_global_nav(self) -> None:
        ...
        self.assertIn("<h1>Nexus</h1>", html)
    ...
    def test_system_status_uses_shared_navigation_treatment_and_eye_renders_live_severity(self) -> None:
        ...
        self.assertIn('viewBox="0 0 512 512"', html)
