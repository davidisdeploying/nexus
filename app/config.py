...
class Settings(BaseSettings):
    ...
    # no cross-seat clobber. (FLEET-BUILD-20260705-snapshot-local.)
...
# The fleet. Declared once, imported everywhere.
FLEET: list[Node] = [
    Node(
        ...
        disk_path="/",
        # Loupe and the photo-archive timers moved here from delta 2026-08-07;
        # the rclone trigger touches this marker on a successful NAS-side run.
    ...
    Node(
        ...
        labels={
            "tailscale_ping": "ping · tailnet",
            "ssh_banner": "ssh · banner",
            "remote_icmp": "lan · charlie",
            "remote_icmp_delta": "lan · delta",
            "nas_smb_charlie": "smb · charlie",
    ...
    Node(
        ...
        #
        # 2026-07-04 split (FLEET-BUILD-...-worker2-tunnel-relay-split): both lines
